...
_env_csrf = [origin for origin in os.getenv('CSRF_TRUSTED_ORIGINS', '').split(',') if origin]
CSRF_TRUSTED_ORIGINS = _env_csrf or _default_csrf_trusted
...
# Security & proxy headers for Render (behind TLS proxy)
